        ...
        <div class="container">
            <div class="signup-content">
                ...
                <div class="signup-form">
                    <form action="register2.php?action=add" method="POST" class="register-form" id="register-form">
                        <h2>student registration form</h2>
                        <div class="form-group">
                            <label for="student id">Student ID :</label>
                            <input type="number" min="1" max="20" name="unit" id="unit" required />
                        </div>
                        <div class="form-row">
                        ...
                        <div class="form-group">
                            <label>Already Registered ?
                                <a style="font-size:16px" href="studentlogin.php">Login Here</a>
                            </label>
                        </div>
                    </form>
                </div>
